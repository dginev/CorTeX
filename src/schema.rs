...
table! {
    ...
    historical_runs (id) {
        ...
        /// (Automatically generated by Diesel.)
        no_problem -> Int4,
        /// The `log_info` column of the `historical_runs` table.
        ///
        /// Its SQL type is `Int4`.
        ///
        /// (Automatically generated by Diesel.)
        log_info -> Int4,
        /// The `log_warning` column of the `historical_runs` table.
        ///
        /// Its SQL type is `Int4`.
        ///
        /// (Automatically generated by Diesel.)
        log_warning -> Int4,
        /// The `log_error` column of the `historical_runs` table.
        ///
        /// Its SQL type is `Int4`.
        ///
        /// (Automatically generated by Diesel.)
        log_error -> Int4,
        /// The `log_fatal` column of the `historical_runs` table.
        ///
        /// Its SQL type is `Int4`.
        ///
        /// (Automatically generated by Diesel.)
